...
window.GameI18N = (() => {
    ...
    const translations = {
        ...
        'game.knowledge.radius': { zh: '半径', en: 'Radius' },
        'game.knowledge.area': { zh: '面积 A=πr²', en: 'Area A=πr²' },
        'game.knowledge.tangent': { zh: '切线', en: 'Tangent' },
        'game.knowledge.arcLength': { zh: '弧长', en: 'Arc Length' },
        'game.knowledge.pi': { zh: 'π', en: 'π' },
        'game.knowledge.unitCircle': { zh: '单位圆', en: 'Unit Circle' },
        'game.knowledge.centralAngle': { zh: '圆心角', en: 'Central Angle' },
        'game.knowledge.radian': { zh: '弧度', en: 'Radian' },
        'game.knowledge.sectorArea': { zh: '扇形面积', en: 'Sector Area' },
        'game.knowledge.chordTheorem': { zh: '弦定理', en: 'Chord Theorem' },
        'game.knowledge.secantTheorem': { zh: '割线定理', en: 'Secant Theorem' },
        'game.knowledge.perpendicularBisector': { zh: '垂直平分线', en: 'Perpendicular Bisector' },
        'game.knowledge.reflection': { zh: '反射', en: 'Reflection' },
        'game.premium.badge': { zh: '会员权益', en: 'Premium Benefit' },
        'game.premium.title': { zh: '更多游戏皮肤主题', en: 'More Skin Themes' },
        'game.premium.unlock': { zh: '去开通', en: 'Get Premium' },
        'game.premium.active': { zh: '会员已开通', en: 'Premium Active' },
        'game.premium.status.locked': { zh: '当前未开通：可前往会员页解锁更多皮肤主题', en: 'Not active: visit Premium page to unlock more skin themes.' },
        'game.premium.status.active': { zh: '已开通：{plan}（{remaining}）', en: 'Active: {plan} ({remaining})' },
        'game.premium.remaining.days': { zh: '剩余 {days} 天', en: '{days} days left' },
        'game.premium.remaining.forever': { zh: '长期有效', en: 'Lifetime' },
        ...
        'sniper.skin.hint.premium': { zh: '会员专属', en: 'Premium only' },
        'sniper.skin.hint.games10': { zh: '玩10局解锁', en: 'Play 10 games to unlock' },
        'sniper.skin.hint.premiumOrGames10': { zh: '会员或玩10局解锁', en: 'Premium or play 10 games' },
        'sniper.skin.laserDesc': { zh: '解锁条件: 单局获得 20 次 Perfect', en: 'Unlock: Get 20 Perfects in one game' },
        'sniper.skin.bowDesc': { zh: '解锁条件: 会员专属', en: 'Unlock: Premium exclusive' },
        'sniper.skin.purpleDesc': { zh: '解锁条件: 累计击败 5 个 Boss', en: 'Unlock: Defeat 5 Bosses total' },
        'sniper.skin.rainbowDesc': { zh: '解锁条件: 会员专属', en: 'Unlock: Premium exclusive' },
        'sniper.skin.neonDesc': { zh: '解锁条件: 会员专属', en: 'Unlock: Premium exclusive' },
        ...
        'sniper.skin.fireDesc': { zh: '解锁条件: 会员专属', en: 'Unlock: Premium exclusive' },
        'sniper.skin.electricDesc': { zh: '解锁条件: 累计击败 3 个 Boss', en: 'Unlock: Defeat 3 Bosses total' },
        'sniper.skin.cyberpunkDesc': { zh: '解锁条件: 会员专属', en: 'Unlock: Premium exclusive' },
        'sniper.skin.oceanDesc': { zh: '解锁条件: 会员专属，或累计游玩 10 局游戏', en: 'Unlock: Premium exclusive, or play 10 games total' },
        'sniper.skin.purple': { zh: '紫色', en: 'Purple' },
        'sniper.skin.rainbow': { zh: '彩虹', en: 'Rainbow' },
        'sniper.skin.neon': { zh: '霓虹', en: 'Neon' },
        'sniper.skin.minimal': { zh: '极简', en: 'Minimal' },
