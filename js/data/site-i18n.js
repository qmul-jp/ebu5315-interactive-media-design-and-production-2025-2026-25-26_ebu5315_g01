...
(function () {
    const dict = {
        en: {
            ...
            'learn.tier.advanced.heading': 'Theorems in this section use diagrams from the Advanced set. Card titles are taken from image file names until final copy is added.',
            'learn.tier.moreAdvanced.badge': 'Further Advanced',
            'learn.tier.moreAdvanced.heading': 'Theorems in this section use diagrams from the Further Advanced set. Card titles are taken from image file names until final copy is added.',
        ...
        zh: {
            ...
            'learn.tier.advanced.heading': '本组定理配图来自「进阶」素材。卡片标题暂取自图片文件名，正式文案稍后补充。',
            'learn.tier.moreAdvanced.badge': '更进阶',
            'learn.tier.moreAdvanced.heading': '本组定理配图来自「更进阶」素材。卡片标题暂取自图片文件名，正式文案稍后补充。',
